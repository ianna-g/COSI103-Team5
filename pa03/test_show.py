...
def test_show_transaction():
    ...
    ex="[{'item #': 1, 'amount': 10.0, 'category': 1, "
    ex2="'date': '2023-03-25', 'description': 'testing123'}]"
    assert str(t_trans.show_transactions()) == ex + ex2
    ...
    ex = """ 'description': 'testing123'}]"""
    assert str(t_trans.show_transactions()) == expected + ex
